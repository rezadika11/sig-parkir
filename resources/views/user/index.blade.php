...
<body>
    ...
    <main role="main">
        <div data-spy="scroll" data-target="#navbar-example2" data-offset="0">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/assets/img/slider1.png" class="bd-placeholder-img" width="100%" height="100%"
                        ...
                        <div class="container">
                            <div class="carousel-caption text-left">
                                ...
                                <p><a class="btn btn-md btn-primary" href="#filter">Mulai Cari</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="card shadow p-3 mb-5">
                    <div class="card-body">
                        <h2 id="filter" class="card-title mb-4 text-center font-weight-bold">Cari Titik Lokasi Parkir</h2>
                        <div class="row">
                            <div class="col-md-3 mb-4">
                                ...
                                <button type="button" class="btn btn-primary" id="filterLocation">
                                    <li class="fas fa-search"></li> Filter
                                </button>
                            </div>
                            <div class="col-md-9  ">
        ...
        <!--Tentang-->
        <div class="tentang p-5">
            <h2 id="tentang" class="text-center font-weight-bold">Tentang Kami</h2>
            <div class="row">
                <div class="col-lg-6 float-right">
                    <img src="/assets/img/Wavy.png" alt="" class="img-fluid">
                </div>
                <div class="col-lg-6 mt-5">
                    <h4>Sistem Pemetaan Parkir Kota Pekalongan</h4>
                    <p>Merupakan Sistem Pemetaan berbasis geografis yang menggambarkan persebaran Parkir yang ada di
                        Kota Pekalongan</p>
                    <i class="far fa-check-circle"> Mudah diakses oleh masyarakat</i> <br>
                    <i class="far fa-check-circle mt-2"> Informasi yang disajikan cukup lengkap</i> <br>
                    <i class="far fa-check-circle mt-2"> Data ditampilkan dalam bentuk maps</i>

                    <p class="mt-4">Sistem ini memudahkan memudahkan masyarat untuk menemukan parkir di area Kota
                        Pekalongan</p>
                </div>
            </div>
        </div>
