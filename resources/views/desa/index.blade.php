...
<div class="main-content" style="min-height: 531px;">
	<section class="section">
	  <div class="section-header">
		<h1>@yield('title')</h1>
			<a href="{{ route('desa.tambahdesa') }}" class="btn btn-sm btn-primary ml-2"><i class="fas fa-plus-circle"></i> Tambah Desa</a>
	  </div>
								...
								<tbody>
									@foreach ($data as $desa)
										<tr>
											...
											<td>
												<a href="{{ route('desa.editdesa', $desa->id_desa) }}" class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i></a>
												<form action="{{ route('desa.hapusdesa', $desa->id_desa) }}" method="POST" class="d-inline">
													@csrf
