                                ...
                                <tbody>
                                    @foreach ($data as $kec)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('kecamatan.editkecamatan', $kec->id_kecamatan) }}" class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                               <form action="{{ route('kecamatan.hapuskecamatan', $kec->id_kecamatan) }}" method="POST" class="d-inline">
                                                @csrf
